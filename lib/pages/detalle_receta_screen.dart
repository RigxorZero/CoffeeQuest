                ...
                itemBuilder: (context, index) 
                {
                  ...
                  (
                    ...
                    (
                      ...
                      onTap: () 
                      {
                        // LOGICA DE EQUIPO: IMPLEMENTAR, NO OLVIDAR!!!!!
                        ScaffoldMessenger.of(context).showSnackBar
                        (
                          SnackBar(content: Text('Has seleccionado: ${equipo.nombreEquipo}')),
                        );
                      },
                    ),
                  );
                ...
                onPressed: () 
                {
                  if (_calificacionSeleccionada != null && _comentarioController.text.isNotEmpty) 
                  {
                    ...
                    (
                      ...
                      creador: widget.usuarioActual, // Usa el usuario actual como creador
                    );
